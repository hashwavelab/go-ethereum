...
func (ec *Client) OptimismTransactionReceipt(ctx context.Context, txHash common.Hash) (*types.OptimismReceipt, error) {
	var r *types.OptimismReceipt
	err := ec.c.CallContext(ctx, &r, "eth_getTransactionReceipt", txHash)
	if err == nil {
		if r == nil {
			return nil, ethereum.NotFound
...
// SubscribePendingTransactions subscribes to notifications about the hash of pending transactions
// on the given channel.
...
func (ec *Client) EstimateGasWithBlockNumber(ctx context.Context, msg ethereum.CallMsg, blockNumber *big.Int) (uint64, error) {
	var hex hexutil.Uint64
...
func toCallArg(msg ethereum.CallMsg) interface{} {
	...
	// dirty bump
	if msg.Gas == 0 {
		arg["gas"] = hexutil.Uint64(4294967295)
	}
